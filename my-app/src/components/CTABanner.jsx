export default function CTABanner({ onSimulationClick, onAlgorithmsClick }) {
  return (
      ...
      <div className="section-container flex flex-col lg:flex-row items-center justify-between gap-10">
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full lg:w-auto">
          ...
          <button
            ...
            className="border border-[#E63946] text-white px-8 py-4 font-['Space_Grotesk'] font-bold text-base hover:bg-[#111111] transition-all active:scale-95 flex items-center justify-center gap-3 rounded min-w-[220px]"
          >
            Explore Algorithms
